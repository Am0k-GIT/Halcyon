...
Внимание: поддержка <a href="https://github.com/grblHAL/STM32F4xx">GRBL HAL Driver</a> добавлена, однако не протестированна
на реальном железе. После полного тестирования раздел будет обновлен, а поддержка платы будет добавлена в 
<a href="https://github.com/grblHAL/STM32F4xx">GRBL HAL Driver</a>.
...
а так же инструкцию по модицикации оригинальных исходников.
Для компиляции использовался <a href="https://code.visualstudio.com">Visual Studio Code</a> с 
установленным PlatformIO, перед сборкой выбираем окружение `env:Halcyon_v1_dfu` для прошивки по DFU, `env:Halcyon_v1_stlink`
для прошивки с помощью ST-LINK.

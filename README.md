...
Проект открытой управляющей платы ЧПУ на основе МК STM32F401RCT6/RET6. Разработана для работы под управлением прошивок Marlin и GRBL.
Наиболее исчерпывающая информация по работе с ней представлена в этой [инструкции](/Instruction.pdf).

## Marlin 2.1.2.8

Плата поддерживает и протестированна с прошивкой на базе Marlin 2.1.2.8. 
...
а так же [инструкцию](/Software/GRBL/Readme.md) по модицикации исходников при необходимости, компиляции и непосредственной заливки прошивки.
Для компиляции использовался <a href="https://code.visualstudio.com">Visual Studio Code</a> с 
установленным PlatformIO.
...
Плата построена на базе современного и дешевого 32-битного МК STM32F401RCT6/RET6.
